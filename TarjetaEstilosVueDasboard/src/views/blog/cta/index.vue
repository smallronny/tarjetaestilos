...
const model = reactive(new Cta(null, null, null, null, null, null,null));
const modelN = reactive(new Cta(null, null, null, null, null, null,null));
const menu_id = ref(0);
    ...
    try {
      ...
      if (response.data.data) {
        ...
        if(response.data.status===201 && response.data.data){
          ...
          Object.assign(modelN, new Cta(null, null, null, null, null, null));
          image.value = null;
          file.value = null;
          date.value = null;
          logo.value = null;
        ...
        <v-form ref="formAdd" v-model="valid" lazy-validation>
          <v-row class="mt-1 mb-1" > 
            <v-col cols="12" sm="12" md="12" lg="12" >
              ...
              <v-text-field label="Url" placeholder="Url" v-model="modelN.url" 
