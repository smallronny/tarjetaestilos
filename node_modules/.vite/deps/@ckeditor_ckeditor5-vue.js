  ...
  "node_modules/@ckeditor/ckeditor5-vue/dist/ckeditor.js"(exports, module) {
    !(function(t, e) {
      ...
      return (function(t2) {
        ...
        var C = function(t3, e2, n2) {
          ...
          function j2() {
            ...
            if (o2 = arguments, i2 = this, l2 = t4, n3) {
              ...
              if (p2) return clearTimeout(c2), c2 = setTimeout(y2, e2), v2(l2);
            }
        ...
        if (k < 3) throw new Error("The CKEditor plugin works only with Vue 3+. For more information, please refer to https://ckeditor.com/docs/ckeditor5/latest/builds/guides/integration/frameworks/vuejs-v3.html");
        const K = { install(t3) {
